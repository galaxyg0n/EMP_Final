...
SemaphoreHandle_t E_MOVE_MUTEX, ROT_ENC_OK, ROT_ENC_FLOOR, ROT_ENC_FIX, ROT_UPD_VAL;
...
int main(void)
{
    ...
    rot_debounce = xTimerCreate("Rotary encode debounce", 10 / portTICK_RATE_MS, pdFALSE, NULL, rotary_timer_callback);
